...
fun calcCommission(actionLimits: Boolean, totalLimits: Boolean): String {
    ...
    val totalComissionMAESTROMASTERCARD = transferAmount * commissionMAESTROMASTERCARD + addCommissionMAESTROMASTERCARD //комиссия по карте MAESTRO и MASTERCARD без акции
    val transferAmountCommissionMAESTROMASTERCARD = transferAmount - totalComissionMAESTROMASTERCARD //вычет комиссии по картам MAESTRO и MASTERCARD без акции
    val transferAmountMinCommissionVISAMIR = transferAmount - minComissionVISAMIR //вычет минимальной комиссии по картам VISA и MIR
    val totalCommissionVISAMIR = transferAmount * commissionVISAMIR //стандартная комиссия по картам VISA и MIR
    val transferAmountCommissionVISAMIR = transferAmount - totalCommissionVISAMIR //вычет стандартной комиссии по картам VISA и MIR
